            ...
            <div class="header-menu-left-content">
                <div class="pull-left">
                    <div class="toggle-wrap btn-toggle-menu-left">
                        <img src="<?php echo esc_url( get_template_directory_uri() . '/v2/images/assets/ico_menu-options.svg' ) ?>" alt="ico-menu">
                    </div>
                    <div class="logo">
            ...
            <div class="menu-header">
                <div class="menu-header-logo">
                    <a href="<?php echo esc_url(home_url('/')) ?>">
                        ...
                        if( !empty( $hotel_alone_logo_light ) && isset( $hotel_alone_logo_light ) ) : ?>
                            <img src="<?php echo esc_url( $hotel_alone_logo_light ) ?>" alt="<?php esc_html_e( "logo", ST_TEXTDOMAIN ) ?>" />
                            <?php
                        else : ?>
                            <h3 style="padding: 8px 0px;"><?php bloginfo( 'name' ) ?></h3>
                            <?php
                ...
                <div class="menu-header-close-menu back-menu">
                    <span class="icon-close-menu btn-toggle-close-menu-left">
                        <img src="<?php echo esc_url( get_template_directory_uri() . '/v2/images/assets/ico_close_3.svg' ) ?>" alt="ico-close">
                    </span>
                </div>
            </div>
