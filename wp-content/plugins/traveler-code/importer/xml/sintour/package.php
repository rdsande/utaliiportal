 ...
 * Time: 9:41 SA
 */
if (!class_exists('ST_SinTour_Package')) {
    class ST_SinTour_Package
    {
        static $_instance;
        ...
        function __construct()
        {
            ...
            add_filter('st_demo_packages_config_sintour', array($this, '_get_config'));
        }
