 ...
 * Time: 9:41 SA
 */
if(!class_exists('ST_Affiliate_Package'))
{
	class ST_Affiliate_Package
	{
		static $_instance;
		...
		function __construct()
		{
			...
			add_filter('st_demo_packages_config_affiliate',array($this,'_get_config'));
		}
